...
import { getSoccerMatches, getBetfairOddsForRunner } from '../../actions/matchaction';
...
const ViewSoccerMatch = () => {
  ...
  // Backend-filtered, always array
  const matches = useMemo(() => Array.isArray(soccerMatches) ? soccerMatches : [], [soccerMatches]);
  ...
  if (loading && !matches.length) return <div>Loading soccer matches...</div>;
